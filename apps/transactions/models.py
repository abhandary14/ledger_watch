...
class Transaction(models.Model):
    ...
    amount = models.DecimalField(
        ...
        help_text="Transaction amount in the organization's currency. Must be greater than zero.",
    )
    ...
    class Meta:
        ...
        constraints = [
            # DB-level guard: rejects negative/zero amounts even from raw SQL or bulk_create.
    ...
    def clean(self) -> None:
        """Model-level validation — runs via full_clean() in admin and explicit calls."""
        super().clean()
